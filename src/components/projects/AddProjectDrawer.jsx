...
const AddProjectDrawer = React.memo(({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event) => {
      if (isInitialMount.current || usersLoading || !sidebarRef.current || sidebarRef.current.contains(event.target)) {
        return;
      }
      onClose();
    };
  ...
  return (
    <div
      ...
      } w-[600px] p-6 overflow-y-auto border-l border-gray-200`}
      ref={sidebarRef}
    >
      <h2 className="text-xl font-semibold text-gray-800 mb-6">Add Project</h2>
